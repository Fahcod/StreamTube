...
const LoginPage = () => {
  ...
  return (
    ...
    <div className="flex w-full h-[100vh] overflow-y-auto items-center justify-center">
        {/* the form */}
        <div className="w-[390px] pb-8 md:shadow-sm rounded-md md:bg-white">
        {/* the heading */}
        <div className="w-full text-center py-3">
        <h1 className="font-[roboto-black] text-xl">Login to Stream<span className="text-[#ed3833]">Tube</span></h1>
        </div>
        {/* the form fields */}
        ...
        <input type="email" onBlur={handleBlur} onChange={handleChange} value={values.email} name="email" className="p-2 border-solid border-[1px] border-gray-200 w-full rounded-md outline-none" autoComplete="off" placeholder="Your full email"/>
        ...
        <input type="password" name="password" onChange={handleChange} onBlur={handleBlur} className="p-2 border-solid border-[1px] border-gray-200 w-full rounded-md outline-none" autoComplete="off" placeholder="Your full password"/>
        ...
        <p className="text-sm font-[rubik-light] text-[#454545] pt-2">Dont have an account?<Link to="/signup">Signup</Link></p>
        </div>

        <div  className="w-full">
        <p className="text-center text-[#454545]">or</p>
        <hr className="mt-3 outline-none border-none h-[1px] bg-gray-200"/>
        <button type="button" className="bg-[#efefef] p-2 rounded-md w-full flex items-center mt-3 cursor-pointer gap-4 justify-center">
